...
New-NetFirewallRule -DisplayName $firewallRuleName -Direction Inbound -Protocol TCP -LocalPort 8080 -Action Allow > $null
...
# New-WebBinding -Name "Default Web Site" -IP "*" -Port 443 -Protocol net.tcp
...
cd IIS:\SslBindings
Write-Host($cert)
netsh http add sslcert ipport=0.0.0.0:8080 certhash=$cert.Thumbprint appid={8cb4aa02-9d21-4b2e-ab5f-e0d46038a12f} clientcertnegotiation=enable
# $cert | New-Item 0.0.0.0!8080 | out-null
